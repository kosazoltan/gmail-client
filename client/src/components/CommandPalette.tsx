  ...
  const commands: CommandItem[] = useMemo(
    () => [
      // Navigation
      {
        ...
        category: 'navigation',
        keywords: ['home', 'főoldal', 'kezdőlap'],
      },
      {
        id: 'nav-inbox',
        label: 'Beérkezett',
        ...
        category: 'navigation',
        keywords: ['inbox', 'levelek', 'email'],
      },
      {
        id: 'nav-compose',
        label: 'Új levél írása',
        icon: PenSquare,
        action: () => {
          navigate('/compose');
          close();
        ...
        category: 'navigation',
        keywords: ['compose', 'write', 'írás', 'levél'],
        shortcut: 'C',
      },
      {
        id: 'nav-unified',
      ...
      {
        id: 'nav-smart-folders',
        label: 'Smart Folders',
        icon: FolderSearch,
        action: () => {
          navigate('/smart-folders');
          close();
        },
        category: 'navigation',
        keywords: ['smart', 'folders', 'mappák'],
      },
      {
        id: 'nav-by-sender',
        label: 'Küldő szerint',
      ...
      },
      {
        ...
        category: 'navigation',
        keywords: ['invoices', 'számlák'],
      },
      {
        id: 'nav-invoice-automation',
        label: 'Számla automatizálás',
        icon: CalendarClock,
        action: () => {
          navigate('/invoice-automation');
          close();
        },
        category: 'navigation',
        keywords: ['invoice automation', 'számla automatizálás', 'cron', 'újrafuttatás'],
      },
      {
        id: 'nav-trash',
        label: 'Kuka',
      ...
      },
      {
        ...
        category: 'navigation',
        keywords: ['attachments', 'mellékletek', 'csatolmány'],
      },
      {
        id: 'nav-newsletters',
        label: 'Hírlevelek',
        ...
        category: 'navigation',
        keywords: ['newsletters', 'hírlevelek'],
      },
      {
        id: 'nav-reminders',
        label: 'Emlékeztetők',
        ...
        category: 'navigation',
        keywords: ['reminders', 'emlékeztetők'],
      },
      {
        id: 'nav-scheduled',
        label: 'Ütemezett',
      ...
      },
      {
        ...
        category: 'navigation',
        keywords: ['database', 'adatbázis', 'db'],
      },
      {
        id: 'nav-settings',
        label: 'Beállítások',
      ...
      <div className="relative z-10 w-full max-w-lg overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-2xl dark:border-gray-700 dark:bg-gray-900">
        ...
        <div ref={listRef} className="max-h-80 overflow-auto p-2">
          {flatFiltered.length === 0 ? (
            ...
            Object.entries(grouped).map(([category, items]) => (
              <div key={category}>
                <div className="px-2 pt-2 pb-1 text-xs font-medium tracking-wider text-gray-400 uppercase dark:text-gray-500">
        ...
        <div className="flex items-center gap-4 border-t border-gray-200 px-4 py-2 text-xs text-gray-400 dark:border-gray-700 dark:text-gray-500">
          <span className="flex items-center gap-1">
            <kbd className="rounded border border-gray-200 bg-gray-100 px-1 py-0.5 dark:border-gray-600 dark:bg-gray-800">
              ↑↓
            </kbd>
            navigáció
          </span>
