  ...
  return (
    <div className="flex flex-col items-center justify-center h-full bg-gradient-to-br from-blue-50 to-white dark:from-dark-bg dark:to-dark-bg-secondary px-4">
      ...
      <button
        ...
        className="flex items-center gap-3 px-6 py-3 bg-white dark:bg-dark-bg-secondary border border-gray-300 dark:border-dark-border rounded-lg shadow-md hover:shadow-lg hover:bg-gray-50 dark:hover:bg-dark-bg-tertiary transition-all disabled:opacity-50 disabled:cursor-not-allowed"
