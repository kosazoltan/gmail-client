...
export const MARKET_AI_TIMEOUT_BUFFER_MS = 5_000;
...
export const BRIEFING_ANALYSIS_REQUEST_TIMEOUT_MS = 95_000;
export const DEEP_ANALYSIS_REQUEST_TIMEOUT_MS = 90_000;
